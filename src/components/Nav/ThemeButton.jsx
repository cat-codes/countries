...
const ThemeButton = () => {
  ...
  const moonDark = 
    <svg id='moonDark' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  const moonLight = 
    <svg id='moonLight' xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
